...
export const $heading1 = $custom('h1')(style({ fontSize: '2rem', fontWeight: 900, letterSpacing: '.05em', margin: 0 }))
...
export const $heading3 = $custom('h3')(
  style({ fontSize: '1.6rem', fontWeight: 900, letterSpacing: '.05em', margin: 0 })
)
