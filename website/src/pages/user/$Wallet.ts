...
import { awaitPromises, constant, debounce, empty, map, mergeArray, multicast, now, periodic, sample, snapshot, startWith } from "@most/core"
import { applyFactor, combineState, formatFixed, getDuration, getMappedValue, parseFixed, parseReadableNumber, readableTokenAmount, readableTokenAmountLabel, readableUnitAmount, switchMap } from "@puppet/middleware/utils"
import { EIP6963ProviderDetail } from "mipd"
import * as PUPPET from "@puppet/middleware/const"
import { $ButtonToggle, $defaulButtonToggleContainer, $FieldLabeled, $infoLabeledValue, $infoTooltip, $infoTooltipLabel, $labeledhintAdjustment, intermediateText } from "@puppet/middleware/ui-components"
    ...
    $column(spacing.big)(
      ...
      switchMap(params => {
        ...
        return $column(spacing.big)(
          ...
          $card(spacing.big, style({ maxWidth: '600px', width: '100%', alignSelf: 'center' }))(
