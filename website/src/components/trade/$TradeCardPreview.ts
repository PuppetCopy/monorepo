...
export const $TradeCardPreview = (config: ITradeCardPreview) => component((
  ...
  return [
    $container(
      ...
      $column(
        $row(screenUtils.isDesktopScreen ? spacing.big : spacing.default, style({ placeContent: 'center', alignItems: 'center', fontFamily: 'Moderat', padding: screenUtils.isDesktopScreen ? '25px 35px 0px' : '35px 35px 0px', zIndex: 11 }))(
