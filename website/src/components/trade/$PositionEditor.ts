...
//     }, combineState({ mirrorPosition, leverage, walletBalance, sizeDeltaUsd, indexPrice, isIncrease, adjustmentFeeUsd, collateralPrice, netPositionValueUsd }), collateralEffects))
//   ]))
...
//         $Popover({
//           open: constant(
//             $column(spacing.default, style({ width: '300px' }))(
...
//         $column(spacing.small, style({ padding: `${BOX_SPACING}px`, borderRadius: `${BOX_SPACING}px ${BOX_SPACING}px 0 0`, border: `1px solid ${colorAlpha(pallete.foreground, .20)}` }),
...
//           }, combineState({ focusMode, isIncrease })))
//         )(
//           $row(spacing.small, style({ placeContent: 'space-between' }))(
...
//                 }, combineState({ walletBalance, primaryDescription }))
//               ),
//             ),
//             $hintAdjustment({
...
//               }, combineState({ mirrorPosition, primaryPrice, collateralDeltaAmount, netPositionValueUsd })),
...
//                 const collateralDeltaUsd = params.collateralDeltaAmount * params.primaryPrice
//                 return readableUsd(params.netPositionValueUsd || collateralDeltaUsd)
//               }, combineState({ collateralDeltaAmount, primaryPrice, netPositionValueUsd })),
//             }),
//           ),
//           $row(spacing.small, style({ alignItems: 'center' }))(
...
//                       }, combineState({ balanceAmountQuery, latestPriceMap }))),
//                     )
//                   )
//                 }),
//                 list: [
...
//                 return false
//               }, combineState({ walletBalance, collateralDeltaAmount, mirrorPosition, isIncrease })),
...
//                       return null
//                     }, combineState({ primaryDescription, primaryPrice }), autoChangeCollateralAmount))
//                   )
//                 ),
//                 switchLatest
//               ),
...
//                   return parsedInput
//                 }, combineState({ primaryDescription, primaryPrice }), src),
//                 // multicast
//               ),
//             )(),
...
//               return 0
//             }, combineState({ mirrorPosition, isIncrease, focusMode, sizeDeltaUsd, walletBalance, collateralDeltaAmount, netPositionValueUsd, adjustmentFeeUsd, primaryPrice })),
//             max: map(params => {
//               if (params.mirrorPosition === null) {
//                 return 1
//               }
...
//               return 1
//             }, combineState({ sizeDeltaUsd, walletBalance, collateralDeltaAmount, netPositionValueUsd, adjustmentFeeUsd, mirrorPosition, primaryPrice, focusMode, isIncrease })),
...
//                       return null
//                     }, combineState({ indexDescription, indexPrice, }), autoChangeSize))
//                   )
//                 ),
//                 switchLatest
//               ),
...
//                 }, combineState({ indexDescription, marketPrice }), src),
//                 // multicast
//               )
//             )(),
...
//               }, combineState({ sizeDeltaUsd, mirrorPosition })),
//               color: map(isInc => isInc ? pallete.positive : pallete.indeterminate, config.tradeConfig.isIncrease),
