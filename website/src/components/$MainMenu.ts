...
export const $MainMenu = (config: MainMenu) => component((
  ...
  return [
    ...
    $row(
      ...
      $column(spacing.big, style({ flex: 1, alignItems: 'flex-start' }))(
        $RouterAnchor({
          url: '/',
          route: route,
      ...
      $row(spacing.big, style({ flex: 1, alignItems: 'center', placeContent: 'center' }))(
        style({ padding: 0 })(
          $pageLink({
...
export const $MainMenuMobile = (config: MainMenu) => component((
  ...
  return [
    ...
    $row(spacing.big, style({ padding: '14px', flexShrink: 0, alignItems: 'flex-end', borderRadius: '30px', placeContent: 'space-between' }))(
      $row(spacing.big, style({ alignItems: 'center', flex: 1 }))(
      ...
      $row(spacing.big, style({ placeContent: 'flex-end', flex: 1 }))(
        $extraMenuPopover,
      )
    ),
