import { component, type I$Node, type INode, type INodeCompose, type IOps, nodeEvent, style } from 'aelea/core'
import { constant, type IBehavior, type IStream, now, switchLatest, switchMap, toStream } from 'aelea/stream'
