...
self.addEventListener('fetch', event => {
  ...
  // Do not cache stateful endpoints (status polls, write operations, intents)
  const noCachePaths = ['/api/indexer/status', '/api/indexer/sql/db', '/api/orchestrator/intent-operation']
