...
export const keeperExecutionStatus = onchainEnum('keeperExecutionStatus', [
  'SUBMITTED', //
  'SUBMISSION_FAILED', //
  'GAS_ESTIMATION_FAILED', //
  'INVALID_NATIVE_TOKEN_PRICE',
  'INVALID_COLLATERAL_TOKEN_PRICE',
  'FEE_CALCULATION_ERROR',
  'TOKEN_METADATA_NOT_FOUND'
])

export const matchingOrder = onchainTable('MatchingOrder', (t) => ({
  id: t.text().primaryKey(),
  sourceTimestamp: t.bigint().notNull(),
  executionTimestamp: t.bigint().notNull(),

  transactionHash: t.hex().notNull(),

  sourceRequestKey: t.hex().notNull(),
  sourcePositionKey: t.hex().notNull(),

  status: keeperExecutionStatus('keeperExecutionStatus').notNull(),

  puppetList: t.hex().array().notNull()
}))

// export const matchingOrderExecuted = onchainTable('MatchingOrderExecuted', (t) => ({

// }))

// export const matchingOrderFailed = onchainTable('MatchingOrderFailed', (t) => ({

// }))

// export const matchingOrderCanceled = onchainTable('MatchingOrderCanceled', (t) => ({
