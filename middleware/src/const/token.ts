...
import { mapArrayBy } from '../core/utils.js'
...
export const TOKEN_DESCRIPTION_MAP = mapArrayBy(
...
export const TOKEN_ADDRESS_DESCRIPTION_MAP = {
  ...
  [ARBITRUM_ADDRESS.WLD]: TOKEN_DESCRIPTION_MAP.WLD,
  [ARBITRUM_ADDRESS.BONK]: TOKEN_DESCRIPTION_MAP.BONK,
  [ARBITRUM_ADDRESS.TAO]: TOKEN_DESCRIPTION_MAP.TAO,
  [ARBITRUM_ADDRESS.BOME]: TOKEN_DESCRIPTION_MAP.BOME,
  [ARBITRUM_ADDRESS.FLOKI]: TOKEN_DESCRIPTION_MAP.FLOKI,
  [ARBITRUM_ADDRESS.MEME]: TOKEN_DESCRIPTION_MAP.MEME,
  [ARBITRUM_ADDRESS.MEW]: TOKEN_DESCRIPTION_MAP.MEW,
  [ARBITRUM_ADDRESS.PENDLE]: TOKEN_DESCRIPTION_MAP.PENDLE,
  [ARBITRUM_ADDRESS.BCH]: TOKEN_DESCRIPTION_MAP.BCH,
  [ARBITRUM_ADDRESS.ICP]: TOKEN_DESCRIPTION_MAP.ICP,
  [ARBITRUM_ADDRESS.XLM]: TOKEN_DESCRIPTION_MAP.XLM,
  [ARBITRUM_ADDRESS.RENDER]: TOKEN_DESCRIPTION_MAP.RENDER,
  [ARBITRUM_ADDRESS.FIL]: TOKEN_DESCRIPTION_MAP.FIL,
  [ARBITRUM_ADDRESS.DYDX]: TOKEN_DESCRIPTION_MAP.DYDX,
  [ARBITRUM_ADDRESS.INJ]: TOKEN_DESCRIPTION_MAP.INJ,
