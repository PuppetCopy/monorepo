export default [
  {
    inputs: [
      ...
      {
        components: [
          { internalType: "uint256", name: "limitFactor", type: "uint256" },
          { internalType: "uint256", name: "durationWindow", type: "uint256" },
        ],
  ...
  { inputs: [], name: "Puppet__CoreShareExceedsMining", type: "error" },
  {
    inputs: [
      { internalType: "uint256", name: "rateLimit", type: "uint256" },
      { internalType: "uint256", name: "emissionRate", type: "uint256" },
    ],
    name: "Puppet__ExceededRateLimit",
    type: "error",
  },
  { inputs: [], name: "Puppet__InvalidRate", type: "error" },
  {
  ...
  {
    inputs: [
      { internalType: "uint256", name: "_lastMintTime", type: "uint256" },
    ],
