export default [
  {
    ...
    inputs: [
      ...
      { name: "_store", type: "address", internalType: "contract PuppetStore" },
    ],
  ...
  },
  {
    ...
    inputs: [],
    outputs: [
      { name: "minExpiryDuration", type: "uint256", internalType: "uint256" },
      { name: "minAllowanceRate", type: "uint256", internalType: "uint256" },
      { name: "maxAllowanceRate", type: "uint256", internalType: "uint256" },
      {
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: "puppet", type: "address", internalType: "address" },
